...
while {1 == 1} do {
	...
	_DebugText 	= 	_DebugText + format ["<t size='0.8' font='Zeppelin33' align='left' color='#CCCCCC'>%1</t><br/>", _spacer];
	_DebugText 	= 	_DebugText + format ["<t size='1.1' font='Zeppelin33' align='center' color='#D9FF00'>Рестарт через: </t><t size='1.2' font='Zeppelin33' align='center' color='#FFFFFF'>%1ч %2мин</t><br/>", _hours, _minutes];
