...
class Restrictions(object):
	...
	def __init__(self, instance):
		...
		if self.cfgname in SERVERS:
			...
			### Regular Expressions!.
			################################################################################################################
			self.addbackpackcargo_regex 	= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: addbackpackcargo restriction #(\d+)', re.I)
			self.addmagazinecargo_regex 	= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: addmagazinecargo restriction #(\d+)', re.I)
			self.attachto_regex 			= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: attachto restriction #(\d+)', re.I)
			self.addweaponcargo_regex 		= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: addweaponcargo restriction #(\d+)', re.I)
			self.createvehicle_regex 		= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: createvehicle restriction #(\d+)', re.I)
			self.deletevehicle_regex 		= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: deletevehicle restriction #(\d+)', re.I)
			self.mpeventhandler_regex 		= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: mpeventhandler restriction #(\d+)', re.I)
			self.publicvariable_regex 		= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: publicVariable restriction #(\d+)', re.I)
			self.publicvariableval_regex 	= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: publicVariable value restriction #(\d+)', re.I)
			self.remotecontrol_regex 		= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: remoteControl restriction #(\d+)', re.I)
			self.remoteexec_regex 			= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: remoteExec restriction #(\d+)', re.I)
			self.script_regex 				= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: script restriction #(\d+)', re.I)
			self.selectplayer_regex 		= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: selectplayer restriction #(\d+)', re.I)
			self.setdamage_regex 			= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: setdamage restriction #(\d+)', re.I)
			self.setvariable_regex 			= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: setvariable restriction #(\d+)', re.I)
			self.setvariableval_regex 		= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: setvariable value restriction #(\d+)', re.I)
			self.teamswitch_regex 			= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: teamswitch restriction #(\d+)', re.I)
			self.waypointcondition_regex 	= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: waypointcondition restriction #(\d+)', re.I)
			self.waypointstatement_regex 	= re.compile(r'Player #(\d+) (.+) \((.{32})\) has been kicked by AntiHack: waypointstatement restriction #(\d+)', re.I)
