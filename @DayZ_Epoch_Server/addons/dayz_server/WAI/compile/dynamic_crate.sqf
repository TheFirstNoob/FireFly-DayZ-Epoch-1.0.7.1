...
{
	diag_log format["[WAI]: [dynamic_crate.sqf]: [ОТЛАДКА]: Создаем ящит с лутом: %1 оружия, %2 инструменты, %3 предметов %4 пистолетом и %5 рюкзаков",_numWeapons,_numTools,_numItems,_numPistols,_numPacks];
};