...
{
	diag_log format ["[DZAI]: [veh_regroup.sqf]: [РАСЩИРЕННАЯ ОТЛАДКА]: Запрос на перегруппировку ИИ для: %1 на технике: %2. Проверка подсчета WP: %3.",_unitGroup,typeOf _vehicle,(count (waypoints _unitGroup))];
};
