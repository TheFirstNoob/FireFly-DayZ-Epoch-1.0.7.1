...
if (!isNull _trigger) then
{
	...
	{
		diag_log format ["[DZAI]: [heli_reinforce.sqf]: [РАСШИРЕННАЯ ОТЛАДКА]: Вертолет %1 (%2) перенаправлен в динамическую зону создания ИИ на позицию: %3.",_helicopter,(typeOf _helicopter),mapGridPosition _reinforcePos]
	};
};
