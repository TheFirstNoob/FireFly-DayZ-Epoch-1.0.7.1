...
// Не добавляйте _roadList, _buildingList или _serverVehicleCounter в private функции
...
else
{
	...
	_isCessna 	= 	_vehicle in ["GNT_C185C_DZ","GNT_C185R_DZ","GNT_C185_DZ","GNT_C185U_DZ"]; 	// Ряд моделей Cessna нестабильны и не должны появляться в ангарах.
	...
	call {
		...
		// Создадим AN2 и GyroCopter в Ангарах и на Взлетно-Посадочной полосе
		...
		{	
			...
			//diag_log("[СЕРВЕР]: [spawn_vehicle.sqf]: [ОТКЛАДКА]: Создано техники возле Дорог: " + str(_position));
		}
		else
		{
			...
			//diag_log("[СЕРВЕР]: [spawn_vehicle.sqf]: [ОТКЛАДКА]: Создано техники возле Зданий " + str(_position));
		};
	};
